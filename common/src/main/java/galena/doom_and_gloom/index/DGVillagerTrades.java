...
@EventBusSubscriber(modid = DoomAndGloom.MOD_ID, bus = EventBusSubscriber.Bus.FORGE)
public class DGVillagerTrades {
    ...
    private static void addGravetenderTrades(VillagerTradesEvent event) {
        ...
        trades.put(2, List.of(
                ...
                new TagForEmeralds(DGTags.Items.VIGIL_CANDLES, 2, 1, 12, 10, 2F),
